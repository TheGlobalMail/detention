define([
  ...
  router.on('change', function(){
    ...
    if (!flags.anyFlags()){
      ...
      text = 'Incidents that another reader has flagged as being of particular interest or concern are highlighted in the grid with this icon. View an incident to flag it yourself. ';
      css = 'sharedflags';
    }else{
